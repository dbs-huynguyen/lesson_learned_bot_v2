...
#     sentence: str = Field(..., description="The sentence in the answer")
#     reason: str = Field(..., description="The reason for the classification")
#     attributed: int = Field(..., description="Whether the sentence can be attributed to the context (1 for Yes, 0 for No)")
